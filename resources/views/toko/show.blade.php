 ...
 <div class="col-md-12">
     <div class="panel panel-primary">
         ...
         <div class="panel-body">
             ...
             <form action="{{route('toko.orders')}}" method="post">
             ...
             <table class="table">
                 ...
                 <tr>
                     <th>Nama Toko</th>
                     <td align="left">: {{$toko->nama_toko}}</td>
                 </tr>
                 <tr>
                     <th>Kode Cs</th>
                     <th><input type="text" class="form-control" name="kode_cs" value="{{$toko->kode_cs}}"></th>
                 </tr>
                 <tr>
                     <th>Jenis Toko</th>
                     <td ><input type="text" name="jenis_toko" class="form-control" value="{{$toko->jenis_toko}}"></td>
                 </tr>
             </table>
                    ...
                    <div class="inner">
                        <table class="table container" style="">
                            ...
                            <tr>
                                <td>
                                    <b>Nama :</b>
                                    <input type="text" name="nama_customer" class="form-control" placeholder="Silahkan Masukan Nama Customer">
                                </td>
                                <td>
                                    <b>No Handpone :</b>
                                    <input type="text" class="form-control" name="notlp_customer" placeholder="Silahkan Masukan No Handpone customer">
                                </td>
                            </tr>
                            <tr>
                                <td>Alamat
                                ...
                                <td>
                                    <b>Desa/Kelurahan</b>
                                    <input type="text" class="form-control" name="desa_kelurahan" placeholder="Masukan Nama DDesa/Kelurahan">
                                    <b>Kecamtan</b>
                                    <input type="text" class="form-control" name="kecamtan" placeholder="Masukan Nama Kecamatan">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <b>Kota/Kabupaten</b>
                                    <input type="text" class="form-control" name="kota_kabupaten" placeholder="Masukan Nama Kota/Kabupaten">
                                </td>
                                <td>
                                    <b>Provinsi</b>
                                    <input type="text" class="col-xs-2 form-control" name="provinsi" placeholder="Masukan Nama Provinsi"><br>
                                    <b>Kode POS:</b>
