...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Login Aplikasi| Tiga Puspa</title>
  ...
  <body class="animsition page-login-v3 layout-full">
      ...
      <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
        <div class="panel">
          <div class="panel-body">
            <div class="brand">
              <img class="brand-img" src="{{ asset('/assets/images/Logo_kecil.png')}}" alt="...">
    ...
    <script src="g{{ asset('/assets/lobal/vendor/slidepanel/jquery-slidePanel.js')}}"></script>
