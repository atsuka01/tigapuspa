...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ url('global/vendor/flag-icon-css/flag-icon.css')}}">
        ...
        <link rel="stylesheet" href="{{ url('global/vendor/aspieprogress/asPieProgress.css')}}">
  ...
  <body class="animsition dashboard">
                ...
                <ul class="site-menu-sub">
                  <li class="site-menu-item">
                    <a class="animsition-link" href="../pages/email-articles.html">
                      <span class="site-menu-title">Data Rs</span>
                    </a>
                  </li>
                  <li class="site-menu-item">
    ...
    <script src="{{ url('global/js/Plugin/switchery.js')}}"></script>
        ...
        <script src="{{ url('assets/examples/js/dashboard/v2.js')}}"></script>
  </body>
</html>
