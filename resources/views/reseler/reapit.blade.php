	...
	$(function () {
		...
		$('.add').click(function () {
			...
			email ') }}"></td>' +
                ...
                '<td><input type="hidden" onkeyup="hitung4();" class="form-control" name="dis25[]" id="r2"><td>'+
                '<td><input type="hidden"  class="form-control" name="dis15[]" id="h2"><td>'+
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <table class="table ">
                <tr>
                    <td><b>Nama:</b>
                        <input type="text" class="form-control" name="nama_customer" value="{{$transaksirs->nama_customer}}">
                    </td>
                    <td>
                        <b>No Handpone</b>
                        <input type="text" class="form-control" name="notlp_customer" value="{{$transaksirs->notlp_customer}}">
                       
                    </td>
                </tr>
                <tr>
                    <td><b>Kota </b>
                        <input type="text" class="form-control" name="kota_customer" value="{{$transaksirs->kota_customer}}">
                    </td>
                    <td><b>Alamat</b>
                        <input type="text" name="alamat_customer" class="form-control" name="kota_customer" value="{{$transaksirs->alamat_customer}}">
                    </td>
                </tr>
                <tr></tr>
            </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control product_id" name="product_name[]">
                                            ...
                                            <option data-kategori="{{$product->kategori}}" data-kode="{{$product->kode_produk}}" data-jenis="{{$product->jenis_produk}}" data-price="{!! $product->harga_produk !!}" value="{!! $product->nama_produk !!}">{!! $product->nama_produk!!}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td>
