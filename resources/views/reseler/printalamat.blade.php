        ...
        <table class="instruction no-print default">
              ...
              <tr>
                  <td>
                      <!-- GO-SEND INSTANT (80012), GO-SEND SAME DAY (80013)  -->
                          ...
                          <div class="address-label-batch-v2-component__title"><b>{{$transaksirs->nama_toko}}</b></div>
                          .ONLINE
          ...
          <table class="address-label-batch-v2-component__body">
              ...
              <tr>
                  ...
                  <td class="address-label-batch-v2-component__address-to">
                      ...
                      <div class="address-label-batch-v2-component__title">Yth</div>
                          ...
                          <div class="address-label-batch-v2-component__username">{{$transaksirs->nama_customer}}</div>
                      
                      <div class="address-label-batch-v2-component__mobile">{{$transaksirs->notlp_customer}}</div>
                      <div class="address-label-batch-v2-component__address">{{$transaksirs->alamat_customer}},{{$transaksirs->kota_customer}}</div>
                  </td>
              </tr>
          </table>
              ...
              <div class="address-label-batch-v2-component__footer ">
                      <div class="address-label-batch-v2-component__footer-title">Hubungi Kami : {{$transaksirs->tlp_cs}} </div>
                  <!-- GO-SEND INSTANT (80012), GO-SEND SAME DAY (80013)  -->
